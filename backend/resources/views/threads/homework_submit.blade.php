        ...
        @foreach($homeworks as $homework )
            <div class="homework__card">
                ...
                <div class="homework__footer">
                    ...
                    <a href="" class="homework__edit">編集</a>
                    <a href="" class="homework__delete">削除</a>
                </div>
            </div>
        @endforeach
        <form class="homework__submit-form" action="{{route('homework.verify')}}" method="get">
            <label for="comment">宿題内容</label>
            <textarea class="homework__text" id="comment" name="comment"></textarea>
            <label for="name">名前</label>
            <input class="homework__text" type="text" id="name" name="name">
